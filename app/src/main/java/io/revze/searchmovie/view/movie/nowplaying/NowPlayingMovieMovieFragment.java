 ...
 */
public class NowPlayingMovieMovieFragment extends Fragment implements NowPlayingMovieView {
    ...
    public NowPlayingMovieMovieFragment() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        presenter = new NowPlayingMoviePresenter();
        onAttachView();
